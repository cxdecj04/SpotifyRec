...
def prepare_recommender(df1, df2, feature_weights=None):
    ...
    # Prepare TF-IDF vectorizer for categorical features
    vectorizers = {}
    ...
    return {
        ...
        'scaler': scaler,
        'mlb': mlb,
        'vectorizers': vectorizers  # Store TF-IDF vectorizers
    }
...
def transform_features(df, model):
    ...
    # Transform categorical features using TF-IDF
...
def get_recommendations(top_songs_df, dataset_df, model, k=10):
    ...
    # For categorical features (TF-IDF)
